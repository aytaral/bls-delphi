...
uses rsData, rsPostnr, blsFileUtil, rsKundeBrReg, rsFunction, rsKontaktGruppe;
...
begin
  ...
  adoKunde.Parameters.ParamValues['Knr'] := Dm.cdsKundeKONTAKTNR.Value;
  cdsKunde.Open;
...
procedure TfrmKunde.Button1Click(Sender: TObject);
begin
...
begin
  if Pc.ActivePage = tsOkonomi then begin
    adoFordringer.Parameters.ParamValues['IdKlient'] := Dm.g_KlientID;
