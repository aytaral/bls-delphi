...
type
  TRptKvittering = class(TQuickRep)
    QRBand1: TQRBand;
    QRDBText1: TQRDBText;
    QRDBText2: TQRDBText;
    QRDBText3: TQRDBText;
...
procedure TRptKvittering.KvitRptBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
var Reg:TRegistry;
begin
 ...
 Reg.Free;
  ...
  LesMarger(Self);
  ReportTitle := 'Kvittering-' + Dm.FakturaDBFakturanr.AsString;
end;
